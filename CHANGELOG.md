...
## [0.8.0](https://github.com/DennisOSRM/toolbox-rs/compare/v0.7.1...v0.8.0) - 2026-09-22

### Other

- Raise dependency requirements to the latest compatible versions ([#632](https://github.com/DennisOSRM/toolbox-rs/pull/632))
- Bump actions-rust-lang/setup-rust-toolchain from 1 to 2 ([#631](https://github.com/DennisOSRM/toolbox-rs/pull/631))
- Update zstd requirement from 0.13.3 to 0.14.0 ([#630](https://github.com/DennisOSRM/toolbox-rs/pull/630))
- Prefetch in push-relabel's global relabel, gated on the last level cache ([#628](https://github.com/DennisOSRM/toolbox-rs/pull/628))
- Correct the reaches_a_root doc and reset a run's counters ([#627](https://github.com/DennisOSRM/toolbox-rs/pull/627))
- Add BoykovKolmogorov as a third min-cut solver ([#626](https://github.com/DennisOSRM/toolbox-rs/pull/626))
- Cut with push-relabel, and make it what chipper uses ([#625](https://github.com/DennisOSRM/toolbox-rs/pull/625))
- Add a weekly cargo upgrade workflow, and raise thirteen requirements ([#618](https://github.com/DennisOSRM/toolbox-rs/pull/618))
- Assert both indices in CompleteGraph::get_index ([#623](https://github.com/DennisOSRM/toolbox-rs/pull/623))
- Require plain titles and brief comments in AGENTS.md ([#622](https://github.com/DennisOSRM/toolbox-rs/pull/622))
- Write measurement CSV from two examples, and draw rank plots as pdf ([#621](https://github.com/DennisOSRM/toolbox-rs/pull/621))
- Add Customization::update to drop only the tables a changed arc dirties ([#624](https://github.com/DennisOSRM/toolbox-rs/pull/624))
- Add a PostToolUse hook running cargo fmt and clippy ([#619](https://github.com/DennisOSRM/toolbox-rs/pull/619))
- Write the nearest index through BlockWriter, laid out by column for the codec ([#617](https://github.com/DennisOSRM/toolbox-rs/pull/617))
- Add NearestIndex and the Indexed trait, and fold r_tree into them ([#616](https://github.com/DennisOSRM/toolbox-rs/pull/616))
- Add Pool and PagedArray: one byte-budgeted LRU, and direct-indexed arrays on disk ([#615](https://github.com/DennisOSRM/toolbox-rs/pull/615))
- Run-length encode PackedPartition, and move BorderLevels into GraphBlock ([#614](https://github.com/DennisOSRM/toolbox-rs/pull/614))
- Add Arcs, GraphBlock and PagedGraph: an adjacency array read in blocks ([#613](https://github.com/DennisOSRM/toolbox-rs/pull/613))
- Make path unpacking generic over the Overlay trait ([#612](https://github.com/DennisOSRM/toolbox-rs/pull/612))
- Read the cells off a file, hold the coarse levels, and cache the rest ([#611](https://github.com/DennisOSRM/toolbox-rs/pull/611))
- Add the block codecs, the block map and a store to read one back ([#609](https://github.com/DennisOSRM/toolbox-rs/pull/609))
- Pack cell tables at one bit width, and number the cells in key order ([#608](https://github.com/DennisOSRM/toolbox-rs/pull/608))
- Add the cell tree, and run the searches over a trait ([#607](https://github.com/DennisOSRM/toolbox-rs/pull/607))
- Add Phase 0 findings for disk-based MLD storage, and measure node ordering ([#606](https://github.com/DennisOSRM/toolbox-rs/pull/606))
- Rework Level construction: shared border table, partition lookups, flat arrays ([#605](https://github.com/DennisOSRM/toolbox-rs/pull/605))
- Draw the search space with a level at every height ([#604](https://github.com/DennisOSRM/toolbox-rs/pull/604))
- Unpack an MLD path down to the arcs of the graph ([#600](https://github.com/DennisOSRM/toolbox-rs/pull/600))
- Find a node of a cell in an array, and work out every pair of a middling one ([#602](https://github.com/DennisOSRM/toolbox-rs/pull/602))
- Drop the session link from a pull request description ([#601](https://github.com/DennisOSRM/toolbox-rs/pull/601))
...
- Fix the stale path bottleneck of Dinic's augmentation ([#546](https://github.com/DennisOSRM/toolbox-rs/pull/546))

## [0.7.0](https://github.com/DennisOSRM/toolbox-rs/compare/v0.6.0...v0.7.0) - 2026-08-10

### Other

- Remove UnsafeSlice ([#543](https://github.com/DennisOSRM/toolbox-rs/pull/543))
- Speed up the partitioner and remove its unsafe code ([#542](https://github.com/DennisOSRM/toolbox-rs/pull/542))
- Bump actions/checkout from 6 to 7 ([#541](https://github.com/DennisOSRM/toolbox-rs/pull/541))
- Update itertools requirement from 0.14.0 to 0.15.0 ([#540](https://github.com/DennisOSRM/toolbox-rs/pull/540))
- Update geojson requirement from 0.24.1 to 1.0.0 ([#539](https://github.com/DennisOSRM/toolbox-rs/pull/539))
